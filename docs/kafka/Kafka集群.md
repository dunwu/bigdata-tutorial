...
- [3. 副本机制](#3-副本机制)
  - [3.1. Kafka 副本角色](#31-kafka-副本角色)
  - [3.2. ISR](#32-isr)
- [4. 选举 Leader](#4-选举-leader)
  - [4.1. Unclean 领导者选举](#41-unclean-领导者选举)
- [5. 处理请求](#5-处理请求)
  - [5.1. 元数据请求](#51-元数据请求)
  - [5.2. 生产请求](#52-生产请求)
  - [5.3. 消费请求](#53-消费请求)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210407180101.png)
