...
- [3. 物理存储](#3-物理存储)
  - [3.1. Log](#31-log)
  - [3.2. Log Segment](#32-log-segment)
- [4. 文件格式](#4-文件格式)
- [5. 索引](#5-索引)
- [6. 清理](#6-清理)
- [7. 删除事件](#7-删除事件)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210615200304.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210615222550.png)
