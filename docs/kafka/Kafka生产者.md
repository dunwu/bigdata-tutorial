...
- [7. 幂等性](#7-幂等性)
  - [7.1. 什么是幂等性](#71-什么是幂等性)
  - [7.2. Kafka Producer 的幂等性](#72-kafka-producer-的幂等性)
  - [7.3. PID 和 Sequence Number](#73-pid-和-sequence-number)
  - [7.4. 生成 PID 的流程](#74-生成-pid-的流程)
  - [7.5. 幂等性的应用实例](#75-幂等性的应用实例)
- [8. Kafka 事务](#8-kafka-事务)
  - [8.1. 事务](#81-事务)
  - [8.2. 事务型 Producer](#82-事务型-producer)
  - [8.3. 事务操作的 API](#83-事务操作的-api)
  - [8.4. Kafka 事务相关配置](#84-kafka-事务相关配置)
  - [8.5. Kafka 事务应用示例](#85-kafka-事务应用示例)
- [9. 生产者的配置](#9-生产者的配置)
- [10. 参考资料](#10-参考资料)
