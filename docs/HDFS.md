...
![img](http://dunwu.test.upcdn.net/cs/bigdata/hdfs/hdfs-architecture.png!zp)
...
![img](http://dunwu.test.upcdn.net/cs/bigdata/hdfs/hdfs-replica.png!zp)
...
![img](http://dunwu.test.upcdn.net/cs/bigdata/hdfs/hdfs-read.png!zp)
...
![img](http://dunwu.test.upcdn.net/cs/bigdata/hdfs/hdfs-write.png!zp)
