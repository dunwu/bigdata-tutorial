...
- [1. 启动服务和启动命令行](#1-启动服务和启动命令行)
- [2. 查看节点列表](#2-查看节点列表)
  - [2.1. `ls` 命令](#21-ls-命令)
  - [2.2. `ls2` 命令](#22-ls2-命令)
- [3. 节点的增删改查](#3-节点的增删改查)
  - [3.1. `get` 命令](#31-get-命令)
  - [3.2. `stat` 命令](#32-stat-命令)
  - [3.3. `create` 命令](#33-create-命令)
  - [3.4. `set` 命令](#34-set-命令)
  - [3.5. `delete` 命令](#35-delete-命令)
- [4. 监听器](#4-监听器)
  - [4.1. get path](#41-get-path)
  - [4.2. stat path](#42-stat-path)
  - [4.3. ls\ls2 path](#43-ls\ls2-path)
- [5. 辅助命令](#5-辅助命令)
- [6. zookeeper 四字命令](#6-zookeeper-四字命令)
- [7. 参考资料](#7-参考资料)
