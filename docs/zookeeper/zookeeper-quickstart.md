...
>
> ***Zab 协议不是 Paxos 算法***，只是比较类似，二者在操作上并不相同。
...
![img](http://dunwu.test.upcdn.net/snap/20200602182548.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200602191358.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200602192341.png)
...
- **文章**
  ...
  - [深入浅出 Zookeeper（一） Zookeeper 架构及 FastLeaderElection 机制](http://www.jasongj.com/zookeeper/fastleaderelection/)D:\Codes\ZPTutorial\ZPDB\bigdata-tutorial\docs\flink\flink.md
