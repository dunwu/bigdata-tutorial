...
module.exports = {
  port: '4000',
  dest: 'docs/.temp',
  base: '/bigdata-tutorial/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  title: 'BIGDATA-TUTORIAL',
  description: '💧 BIGDATA TUTORIAL 是一个大数据教程。',
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: 'Hbase',
        link: '/16.大数据/03.hbase/'
      },
      {
        text: 'ZooKeeper',
        link: '/16.大数据/04.zookeeper/'
      }
    ],
