 ...
 * @since 2020-06-20
 */
public class KafkaConsumerStartFromSpecifiedOffsetDemo {

    private static final Logger log = LoggerFactory.getLogger(KafkaConsumerStartFromSpecifiedOffsetDemo.class);
