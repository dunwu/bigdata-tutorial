...
public class HBaseHelperTests {
	...
	/**
	 * 等价于 put 'table1', 'row1', 'columnFamliy1:a', 'valueA' put 'table1', 'row1', 'columnFamliy1:b', 'valueB' put
	 * 'table1', 'row1', 'columnFamliy1:c', 'valueC' put 'table1', 'row2', 'columnFamliy1:a', 'valueA' put 'table1',
	 * 'row2', 'columnFamliy1:b', 'valueB' put 'table1', 'row2', 'columnFamliy1:c', 'valueC' put 'table1', 'row1',
	 * 'columnFamliy2:a', 'valueA' put 'table1', 'row1', 'columnFamliy2:b', 'valueB' put 'table1', 'row1',
	 * 'columnFamliy2:c', 'valueC'
	 */
	@Test
	public void put() {
		HTableDescriptor[] table1s = HBaseHelper.listTables("table1");
